<?php
    require_once "main.php";
     ...
     /*== Almacenando datos ==*/
     $nombre=limpar_textos($_POST['usuario_nombre']);
     $apellido=limpar_textos($_POST['usuario_apellido']);
 
     $usuario=limpar_textos($_POST['usuario_usurio']);
     $email=limpar_textos($_POST['usuario_email']);
 
     $clave_1=limpar_textos($_POST['usuario_clave_1']);
     $clave_2=limpar_textos($_POST['usuario_clave_2']);
